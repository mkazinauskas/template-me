...
export function fetchOkBlob(content = "pdf-bytes") {
  return {
    ok: true,
    json: async () => ({}),
...
/**
 * Stubs `fetch` (resolving to a fake PDF) and the object-URL helpers, and clears
 * localStorage — SingleFillForm persists values keyed by templateId and restores
 * them on mount, and every test here uses "t1". Pair with restoreFillFormGlobals.
 */
